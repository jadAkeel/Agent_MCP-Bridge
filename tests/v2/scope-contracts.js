...
const contract = normalizeScopeContract({
  ...
  scopeContract: {
    ...
    modelRequirement: { provider: "google", model: "antigravity-gemini-3.8-flash", variant: "high", requireRuntimeEvidence: true },
  },
});
...
assert.deepEqual(contract.modelRequirement, {
  provider: "google",
...
assert.match(formatScopeContractForPrompt(contract), /Required managed provider\/model: google\/antigravity-gemini-3\.8-flash/);
